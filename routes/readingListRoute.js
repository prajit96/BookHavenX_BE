...
readingListRouter.get("/user", authMiddleware, async (req, res) => {
...
readingListRouter.post("/create", authMiddleware, async (req, res)=>{
 ...
 readingListRouter.post("/addbook/:id", authMiddleware, async (req, res)=>{
 ...
 readingListRouter.get("/:id", authMiddleware, async(req, res)=>{
  const readingListID = req.params.id;
  try {
...
readingListRouter.delete("/delete/:id", authMiddleware, async (req, res)=>{
  const {id} = req.params;
  const {userID} = req.body;
  try {
