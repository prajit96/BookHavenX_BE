...
const discussionPostRouter = express.Router();

//Get all discussion posts by discussionID
discussionPostRouter.get("/:id", async (req, res)=>{
    const {id} = req.params;
    try {
...
// create a post
discussionPostRouter.post("/create/:id",authMiddleware, async(req, res)=>{
...
//delete a post by id
discussionPostRouter.delete("/delete/:id", authMiddleware, async(req, res)=>{
