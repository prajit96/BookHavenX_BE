...
purchaseRouter.get("/", authMiddleware, async (req, res)=>{
...
purchaseRouter.get("/:id", authMiddleware, async (req, res)=>{
    const {id} = req.params;
    try {
...
//Create a purchase
purchaseRouter.post("/create",authMiddleware, async(req, res)=>{
...
purchaseRouter.delete("/delete/:id", authMiddleware, async (req, res)=>{
    const {id} = req.params;
    try {
